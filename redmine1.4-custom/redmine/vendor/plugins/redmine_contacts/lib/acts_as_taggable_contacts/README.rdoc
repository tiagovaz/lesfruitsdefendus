...
1. script/generate acts_as_taggable_contacts_migration
2. rake db:migrate
...
1. rails generate acts_as_taggable_contacts:migration
2. rake db:migrate
...
== Usage
    ...
    class User < ActiveRecord::Base
      # Alias for <tt>acts_as_taggable_contacts :tags</tt>:
      acts_as_taggable
      acts_as_taggable_contacts :skills, :interests
    end
...
Tags can have owners:
    ...
    class Photo < ActiveRecord::Base
      acts_as_taggable_contacts :locations
    end
...
Because we specified +acts_as_taggable_contacts+ on the <tt>User</tt> class, we can
