      ...
      def acts_as_tagger(opts={})
        class_eval do
          has_many :owned_taggings, opts.merge(:as => :tagger, :dependent => :destroy,
                                               :include => :tag, :class_name => "ActsAsTaggableContacts::Tagging")
          has_many :owned_tags, :through => :owned_taggings, :source => :tag, :uniq => true, :class_name => "ActsAsTaggableContacts::Tag"
        end

        include ActsAsTaggableContacts::Tagger::InstanceMethods
        extend ActsAsTaggableContacts::Tagger::SingletonMethods
      end
