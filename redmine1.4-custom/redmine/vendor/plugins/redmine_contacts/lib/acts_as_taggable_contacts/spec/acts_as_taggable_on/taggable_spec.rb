...
describe "Taggable" do
  ...
  it "should be able to create tags" do
    ...
    @taggable.instance_variable_get("@skill_list").instance_of?(ActsAsTaggableContacts::TagList).should be_true
    
    lambda {
      @taggable.save
    }.should change(ActsAsTaggableContacts::Tag, :count).by(3)
  ...
  it "should not care about case" do
    ...
    ActsAsTaggableContacts::Tag.find(:all).size.should == 1
  ...
  describe "grouped_column_names_for method" do
    it "should return all column names joined for Tag GROUP clause" do
      @taggable.grouped_column_names_for(ActsAsTaggableContacts::Tag).should == "tags.id, tags.name"
    end
