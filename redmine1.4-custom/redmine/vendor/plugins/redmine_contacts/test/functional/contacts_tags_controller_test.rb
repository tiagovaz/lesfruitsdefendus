...
class ContactsTagsControllerTest < ActionController::TestCase  
  ...
  test "should get edit" do 
    ...
    assert_equal ActsAsTaggableContacts::Tag.find(1), assigns(:tag)
  end

  test "should post update" do 
    @request.session[:user_id] = 1
    tag1 = ActsAsTaggableContacts::Tag.find(1)  
    old_name = tag1.name
  ...
  test "should post destroy" do
    @request.session[:user_id] = 1
    assert_difference 'ActsAsTaggableContacts::Tag.count', -1 do
      post :destroy, :id => 1
      assert_response 302
    end
  end    
